...
function renderType(type: TypeDef): JSX.Element {
    ...
    if (isTypeObject(type)) {
        console.log("🚀 [params-documentation] type = ", type) // @FIXME: Remove this line written on 2021-09-21 at 16:33
    ...
    console.log("🚀 [params-documentation] Don't know what it is = ", type) // @FIXME: Remove this line written on 2021-09-21 at 16:48
