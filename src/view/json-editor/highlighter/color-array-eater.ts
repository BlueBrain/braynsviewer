 ...
 * They are arrays with only 3 elements. Each element
 * must me a real number between 0 and 1 included.
 */
...
function castFloat(data: any, defaultValue: number): number {
